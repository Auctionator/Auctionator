...
Auctionator.Config.Options.SHOPPING_COMPUTE_LIST_TOTAL = "shopping_compute_list_total"
...
Auctionator.Config.Defaults[Auctionator.Config.Options.SHOPPING_COMPUTE_LIST_TOTAL] = false
