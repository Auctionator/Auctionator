...
Auctionator.Constants.DisenchantingProbability = {
  ...
  [ Enum.ItemClass.Weapon ] = {
    [ Enum.ItemQuality.Good ] = {
      ...
      -- { 21, 25, 15, { 4, 6 }, MATS.STRANGE_DUST, 75, { 1, 2 }, MATS.LESSER_MAGIC, 10, 1, MATS.SMALL_GLIMMERING },
      -- { 26, 30, 20, { 1, 2 }, MATS.SOUL_DUST, 75, { 1, 2 }, MATS.GREATER_MAGIC, 5, 1, MATS.LARGE_GLIMMERING },
      ...
      {21,25,5,4,10940,5,5,10940,5,6,10940,37.5,1,10938,37.5,2,10938,10,1,10978},
