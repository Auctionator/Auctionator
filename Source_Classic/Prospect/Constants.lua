...
Auctionator.Prospect.PROSPECT_TABLE = {
  ...
  [PROSPECT_ITEMS.COBALT_ORE] = {
    [PROSPECT_ITEMS.HUGE_CITRINE] = 0.24,
    [PROSPECT_ITEMS.SHADOW_CRYSTAL] = 0.24,
    [PROSPECT_ITEMS.BLOODSTONE] = 0.23,
    [PROSPECT_ITEMS.CHALCEDONY] = 0.23,
    [PROSPECT_ITEMS.DARK_JADE] = 0.23,
    [PROSPECT_ITEMS.SUN_CRYSTAL] = 0.23,
  ...
  [PROSPECT_ITEMS.SARONITE_ORE] = {
    [PROSPECT_ITEMS.BLOODSTONE] = 0.18,
    [PROSPECT_ITEMS.CHALCEDONY] = 0.18,
    [PROSPECT_ITEMS.DARK_JADE] = 0.18,
    [PROSPECT_ITEMS.HUGE_CITRINE] = 0.18,
    [PROSPECT_ITEMS.SHADOW_CRYSTAL] = 0.18,
    [PROSPECT_ITEMS.SUN_CRYSTAL] = 0.18,
    [PROSPECT_ITEMS.AUTUMNS_GLOW] = 0.04,
    [PROSPECT_ITEMS.FOREST_EMERALD] = 0.04,
    [PROSPECT_ITEMS.MONARCH_TOPAZ] = 0.04,
    [PROSPECT_ITEMS.SCARLET_RUBY] = 0.04,
    [PROSPECT_ITEMS.SKY_SAPPHIRE] = 0.04,
    [PROSPECT_ITEMS.TWILIGHT_OPAL] = 0.04,
  },
  [PROSPECT_ITEMS.TITANIUM_ORE] = {
    [PROSPECT_ITEMS.TITANIUM_POWDER] = 0.57,
    [PROSPECT_ITEMS.BLOODSTONE] = 0.23,
    [PROSPECT_ITEMS.CHALCEDONY] = 0.23,
    [PROSPECT_ITEMS.DARK_JADE] = 0.23,
    [PROSPECT_ITEMS.HUGE_CITRINE] = 0.23,
    [PROSPECT_ITEMS.SHADOW_CRYSTAL] = 0.23,
    [PROSPECT_ITEMS.SUN_CRYSTAL] = 0.23,
    [PROSPECT_ITEMS.AUTUMNS_GLOW] = 0.04,
    [PROSPECT_ITEMS.FOREST_EMERALD] = 0.04,
    [PROSPECT_ITEMS.MONARCH_TOPAZ] = 0.04,
    ...
    [PROSPECT_ITEMS.SKY_SAPPHIRE] = 0.04,
    [PROSPECT_ITEMS.TWILIGHT_OPAL] = 0.04,
    [PROSPECT_ITEMS.CARDINAL_RUBY] = 0.04,
    [PROSPECT_ITEMS.DREADSTONE] = 0.04,
    [PROSPECT_ITEMS.EYE_OF_ZUL] = 0.04,
    [PROSPECT_ITEMS.KINGS_AMBER] = 0.04,
    [PROSPECT_ITEMS.MAJESTIC_ZIRCON] = 0.04,
  },
}
