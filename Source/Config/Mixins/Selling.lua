...
function AuctionatorConfigSellingFrameMixin:OnShow()
  ...
  self.PriceHistory:SetChecked(Auctionator.Config.Get(Auctionator.Config.Options.SHOW_PRICE_HISTORY))
end
...
function AuctionatorConfigSellingFrameMixin:Save()
  ...
  Auctionator.Config.Set(Auctionator.Config.Options.SHOW_PRICE_HISTORY, self.PriceHistory:GetChecked())
end
