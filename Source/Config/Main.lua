Auctionator.Config.Options = {
  ...
  ALT_FULL_STACK_TOOLTIPS = "alt_full_stack_tooltips",
  ...
  SELLING_ALWAYS_STAR_ICON = "selling_always_star_icon",
...
Auctionator.Config.Defaults = {
  ...
  [Auctionator.Config.Options.ALT_FULL_STACK_TOOLTIPS] = true,
  ...
  [Auctionator.Config.Options.SELLING_ALWAYS_STAR_ICON] = false,
