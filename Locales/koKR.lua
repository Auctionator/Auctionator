...
L["CONFIG_ENCHANT_TOOLTIP"] = "마법부여 툴팁을 표시합니다(드군, 군단, 격아, 어둠땅만 지원)"
...
--[[Translation missing --]]
L["CONFIG_QUANTITIES_TEXT"] = "다른 아이템 카테고리에 사용되는 기본 수량을 선택합니다."
...
--[[Translation missing --]]
L["CONFIG_SELLING_GEAR_USE_ILVL_VARIANTS"] = "장비의 경우 가격을 선택할 때, 아이템 레벨과 제목을 사용"
--[[Translation missing --]]
L["CONFIG_SELLING_GEAR_USE_ILVL_VARIANTS_TOOLTIP_HEADER"] = "아이템 레벨 및 제목 사용"
--[[Translation missing --]]
L["CONFIG_SELLING_GEAR_USE_ILVL_VARIANTS_TOOLTIP_TEXT"] = "일반적으로 장비는 유사한 다른 장비와 비교되지만 아이템 레벨과 \"의\" 제목은 고려하지 않습니다. 이 옵션은 고려하게 변경합니다."
...
--[[Translation missing --]]
L["CONFIG_SELLING_MISSING_FAVOURITES_TOOLTIP_TEXT"] = "가방에 없는 경우에도 가방 보기에서 즐겨찾기 아이템으로 표시합니다."
...
--[[Translation missing --]]
L["CONFIG_SELLING_POST_SHORTCUT"] = "현재 아이템을 등록하기 위한 키보드/마우스 단축키는"
--[[Translation missing --]]
L["CONFIG_SELLING_POST_SHORTCUT_TOOLTIP_TEXT"] = "클릭한 다음 단축키로 사용하려는 버튼을 누릅니다. 이 단축키는 경매장 판매 탭에서만 활성화되며 버튼에 연결된 다른 단축키에는 영향을 미치지 않습니다."
--[[Translation missing --]]
L["CONFIG_SELLING_SHORTCUTS_CATEGORY"] = "판매: 단축키"
--[[Translation missing --]]
L["CONFIG_SELLING_SHORTCUTS_TEXT"] = "판매 탭 내 키보드 및 마우스 단축키 옵션"
--[[Translation missing --]]
L["CONFIG_SELLING_SHOW_BID_PRICE"] = "아이템을 등록할 때 입찰 가격 옵션 표시 (재시작 필요)"
--[[Translation missing --]]
L["CONFIG_SELLING_SHOW_BID_PRICE_TOOLTIP_HEADER"] = "입찰 옵션"
--[[Translation missing --]]
L["CONFIG_SELLING_SHOW_BID_PRICE_TOOLTIP_TEXT"] = "아이템을 등록할 때 입찰 가격 옵션을 표시할지 결정합니다."
--[[Translation missing --]]
L["CONFIG_SELLING_SKIP_SHORTCUT"] = "현재 선택한 아이템 등록을 건너뛰는 단축키는"
--[[Translation missing --]]
L["CONFIG_SELLING_TBC_ALL_ITEMS"] = "모든 아이템에 대한 기본 등록 설정을 지정하는 옵션입니다."
--[[Translation missing --]]
L["CONFIG_SELLING_TBC_SHOW_ALL_RESULTS"] = "결과에 최소 가격을 얻기 위해 필요하지 않은 경매 포함"
--[[Translation missing --]]
L["CONFIG_SELLING_TBC_SHOW_ALL_RESULTS_TOOLTIP_HEADER"] = "모든 결과 표시"
--[[Translation missing --]]
L["CONFIG_SELLING_TBC_SHOW_ALL_RESULTS_TOOLTIP_TEXT"] = "이 설정을 사용하면 최소 가격을 결정하는 데 첫 페이지만 필요하더라도, 결과의 모든 페이지가 검색되고 발견된 모든 경매가 나열됩니다."
L["CONFIG_SELLING_TEXT"] = "판매하기 탭의 설정을 변경합니다."
L["CONFIG_SHOPPING_CATEGORY"] = "구매목록"
L["CONFIG_SHOPPING_LIST"] = "구매목록 설정"
--[[Translation missing --]]
L["CONFIG_SHOPPING_LIST_MISSING_TERMS"] = "결과에 결과 없음을 구매 목록에 표시합니다."
--[[Translation missing --]]
L["CONFIG_SHOPPING_LIST_MISSING_TERMS_TOOLTIP_HEADER"] = "결과 없음"
--[[Translation missing --]]
L["CONFIG_SHOPPING_LIST_MISSING_TERMS_TOOLTIP_TEXT"] = "검색어에 결과가 없으면 사용 가능한 아이템이 0인 것을 결과에 표시합니다."
...
--[[Translation missing --]]
L["FULL_SCAN_IN_PROGRESS"] = "전체 검색 진행중."
...
L["LIST_SEARCH_START"] = "검색 중... (%s초)"
L["LIST_SEARCH_STATUS"] = "검색 완료 (%s초)"
...
L["RENAME"] = "목록명 변경"
--[[Translation missing --]]
L["RENAME_LIST_CONFIRM"] = "'%s'의 이름을 입력:"
...
--[[Translation missing --]]
L["SELLERS_OVERFLOW_TEXT"] = "%s, 그리고 %s 개 더"
L["SELLING_TAB"] = "판매하기"
...
L["SHOPPING_TAB"] = "구매 목록"
L["SHOPPING_TAB_HEADER"] = "옥셔네이터 - 구매 목록"
--[[Translation missing --]]
L["SKIP"] = "Skip"
--[[Translation missing --]]
L["SORT"] = "종류"
...
L["SPLASH_830_NOT_DONE_1"] = "최저가 확인"
...
L["SPLASH_831_CANCELLING_2"] = "현재 올린 경매장 품목에 대한 최저가를 확인하는 기능이 추가 되었습니다. (최저가 확인)"
...
L["SPLASH_834_SHOPPING_1"] = "이미 생성되 있는 구매 목록을 가져오기/내보내기 할 수 있습니다. "
L["SPLASH_834_SHOPPING_2"] = "구매 목록 탭을 열었을 때 설정을 통해 기존 생성되어 있는 구매목록 중 하나를 선택하여 즉시 검색할 수 있습니다."
L["SPLASH_834_SHOPPING_3"] = "구매 목록을 편집할 수 있습니다."
L["SPLASH_834_SHOPPING_HEADER"] = "구매 목록 탭"
--[[Translation missing --]]
...
--[[Translation missing --]]
L["SPLASH_9105_FEATURES_HEADER"] = "최근 기능"
--[[Translation missing --]]
...
--[[Translation missing --]]
L["SPLASH_9108_FEATURES_HEADER"] = "클래식 릴리스 기능"
