AUCTIONATOR_LOCALES.enUS = function()
  ...
  L["CONFIG_SHOW_LISTS"] = "Show shopping list sidebar when Auction House is opened."
  L["CONFIG_SHOW_LISTS_TOOLTIP_HEADER"] = "Shopping List Sidebar"
  L["CONFIG_SHOW_LISTS_TOOLTIP_TEXT"] = "Shows the shopping list sidebar when the auction house is opened. If the sidebar is hidden, you may show it by clicking the 'Shopping Lists' button in the auction house."
  ...
  L["VENDOR_TOOLTIP_TOOLTIP_TEXT"] = "Show vendor information in tooltip on mouseoverShow vendor tooltips."
